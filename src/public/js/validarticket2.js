...
function validarticket2(){
    var nombre,apellido,correo,telefono,dni,institucion,operacion, expresionemail,expresionnombres,expresionnumeros;

    nombre=document.getElementById("nombretickets2").value;

    apellido=document.getElementById("apellidotickets2").value;

    correo=document.getElementById("correotickets2").value;
    ...
    operacion=document.getElementById("operacionnumero2").value;
