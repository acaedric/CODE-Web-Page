function validaregistro(){
    var nombre,apellido,correo,telefono,dni,institucion, expresionemail,expresionnombres,expresionnumeros;
    ...
    if (nombre === "" || apellido === "" || correo === "" || telefono === ""  || institucion === "" ) {
        ...
        alert("Ingreso de datos exitoso, por favor espere a que la pagina se cargue nuevamente");
    }
}
